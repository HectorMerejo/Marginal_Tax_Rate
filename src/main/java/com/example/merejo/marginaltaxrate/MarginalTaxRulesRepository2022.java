...
public class MarginalTaxRulesRepository2022 implements IQuery<MarginalTaxRules> {

    private List<MarginalTaxRules> finalmarginaltaxrules;

    public MarginalTaxRulesRepository2022(){

        {
            finalmarginaltaxrules = ReadExcelUtility
                    .processRange(Location.RESOURCE, "static/SimpleTaxRate.xlsx"
                            , "rules2022", "B2:E8", 4, MarginalTaxRules::new );
        }
