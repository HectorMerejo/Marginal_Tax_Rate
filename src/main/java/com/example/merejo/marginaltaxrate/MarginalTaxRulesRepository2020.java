...
public class MarginalTaxRulesRepository2020 implements IQuery<MarginalTaxRules> {

    private List<MarginalTaxRules> finalmarginaltaxrules;

    public MarginalTaxRulesRepository2020(){

        {
            finalmarginaltaxrules = ReadExcelUtility
                    .processRange(Location.RESOURCE, "static/SimpleTaxRate.xlsx"
                            , "rules2020", "B2:E8", 4, MarginalTaxRules::new );
        }
    }
    @Override
