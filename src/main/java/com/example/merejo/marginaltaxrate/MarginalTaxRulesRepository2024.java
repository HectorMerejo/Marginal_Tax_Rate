...
public class MarginalTaxRulesRepository2024 implements IQuery<MarginalTaxRules> {

    private List<MarginalTaxRules> finalmarginaltaxrules;

    public MarginalTaxRulesRepository2024(){

        {
            finalmarginaltaxrules = ReadExcelUtility
                    .processRange(Location.RESOURCE, "static/SimpleTaxRate.xlsx"
                            , "rules2024", "B2:E8", 4, MarginalTaxRules::new );
        }
