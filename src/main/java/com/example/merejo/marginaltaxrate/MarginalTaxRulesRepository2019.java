...
public class MarginalTaxRulesRepository2019 implements IQuery<MarginalTaxRules> {
    private final List<MarginalTaxRules> finalmarginaltaxrules;
    public MarginalTaxRulesRepository2019(){
        {
            finalmarginaltaxrules = ReadExcelUtility
                    .processRange(Location.RESOURCE, "static/SimpleTaxRate.xlsx"
                            , "rules2019", "B2:E8", 4, MarginalTaxRules::new );
        }
    }
    @Override
