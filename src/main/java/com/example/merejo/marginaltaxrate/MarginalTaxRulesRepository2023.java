...
public class MarginalTaxRulesRepository2023 implements IQuery<MarginalTaxRules> {

    private List<MarginalTaxRules> finalmarginaltaxrules;

    public MarginalTaxRulesRepository2023(){

        {
            finalmarginaltaxrules = ReadExcelUtility
                    .processRange(Location.RESOURCE, "static/SimpleTaxRate.xlsx"
                            , "rules2023", "B2:E8", 4, MarginalTaxRules::new );
        }
